...
export default function Detail({ navigation, route }) {
    ...
    const handleAddContents = () => {
        ...
        // Find index of array for 'booking_area_pemakaman'
        const index = newContents.findIndex(x => x.val === 'booking_area_pemakaman');
        // Push new variant to array
        newContents[index].id.push({ id: selectedVariant.id, desc: selectedVariant.name, price: selectedVariant.price });
    
        // Set new state
        setAddedContents(newContents);
        setSelectedVariant({ id: '', name: '', price: '' });
    
        // Navigate back to booking_area_pemakaman after updating addedContents
        nav.navigate('booking_area_pemakaman');
    };
